...
//	public static String resize(int width, int height, String savePath, Image targetImage) throws Exception, IOException {
...
//     * @throws IOException
//     */
//	public static String resize(int width, int height, Float quality, String savePath, Image targetImage) throws Exception {
//        width = Math.max(width, 1);
//        height = Math.max(height, 1);
//        BufferedImage image = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
//        image.getGraphics().drawImage(targetImage, 0, 0, width, height, null);
...
//     * @throws IOException
//     */
//    public static String resize(int width, int height, String savePath, File targetFile) throws Exception, IOException {
...
//     * @throws IOException
//     */
//    public static String resize(int width, int height, String savePath, URL targetURL) throws Exception, IOException {
...
//     * @throws IOException
//     */
//    public static String resize(float scale, String savePath, File targetFile) throws Exception, IOException {
//        image = ImageIO.read(targetFile);
...
//     * @throws IOException
//     */
//    public static String resize(float scale, String savePath, URL targetURL) throws Exception, IOException {
//        image = ImageIO.read(targetURL);
//        int[] size = getSize(scale, image);
//        return resize(size[0], size[1], savePath, image);
//    }
...
//     * @throws IOException
//     */
//    public static String resize(int width, String savePath, File targetFile) throws Exception, IOException {
//        image = ImageIO.read(targetFile);
...
//     * @throws IOException
//     */
//    public static String resize(int width, String savePath, URL targetURL) throws Exception, IOException {
//        image = ImageIO.read(targetURL);
//        int[] size = getSize(width, image);
//        return resize(size[0], size[1], savePath, image);
//    }
...
//     * @throws IOException
//     */
//    public static String resizeByHeight(int height, String savePath, File targetFile) throws Exception, IOException {
//        image = ImageIO.read(targetFile);
...
//     * @throws IOException
//     */
//    public static String resizeByHeight(int height, String savePath, URL targetURL) throws Exception, IOException {
//        image = ImageIO.read(targetURL);
//        int[] size = getSizeByHeight(height, image);
//        return resize(size[0], size[1], savePath, image);
//    }
